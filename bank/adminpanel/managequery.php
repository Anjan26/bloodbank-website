...
<div class="container-fluid">
    <div class="row">
		<div class="col-md-12">
            <h2 class="page-title" style="width:80%; padding:0.5%;margin-top:2%; padding-left: 1%; background-color:#b3e6ff;border-radius: 10px; box-shadow: 5px 5px #888888;">Manage Query</h2><br>
            <div class="panel panel-default">
        <div class="panel-heading" style="font-size: 150%; margin-left:1%;"><b>User queries </b></div><hr>
...
<br>
                    ...
                    <?php
                        ...
                        if($row['status'] == 1){
                          echo"<td>Read<br><a href='managequery.php?del=".$row["id"]."'  onclick=\"javascript:return confirm('Do you really want to read?');\" >Delete</a></td>";
                          }else{
                            echo"<td><a href='managequery.php?eid=".$row["id"]."'  onclick=\"javascript:return confirm('Do you really want to read?');\" >Pending</a>
                            <br><a href='managequery.php?eid=".$row["id"]."'  onclick=\"javascript:return confirm('Do you really want to read?');\" >Delete</a></td>";  
                          }
